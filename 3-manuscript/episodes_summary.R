...
summary_index2 <- readRDS("./2-cprd/7_output/tx_summary.RDS")
summary_index1 <- readRDS("./1-pharmo/7_output/tx_summary.RDS")
...
saveWorkbook(wb, file = "output/xlsx/episodes_summary.xlsx", overwrite = TRUE)
